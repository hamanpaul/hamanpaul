...
**[互動式架構圖：hamanpaul]([https://hamanpaul.github.io/index.html](https://hamanpaul.github.io/hamanpaul/))** · [架構事實 facts.json](docs/facts.json) · [Archify 投影 architecture.json](docs/architecture.json) · [來源版本與摘錄索引](docs/source-manifest.json)
